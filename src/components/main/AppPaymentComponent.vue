        ...
        <div class="summary-container p-3 rounded-2">
          ...
          <div class="dish" v-for="item in store.cart">
            <div class="d-flex justify-content-between">
              <p class="w-75 m-0">
                <span class="fw-bold">{{ item.quantity }}</span> x
                {{ item.name }}
              </p>
              <p class="w-25 text-end m-0 fw-bold">
          ...
          <div class="total text-end">
            <p class="m-0 fw-bold">
              <span class="fw-normal pe-1 text-muted small">Totale</span
              >{{ store.totalPrice().toFixed(2) }} &euro;
            </p>
          </div>
        </div>
      </div>
      <div class="col-12 col-lg-5 mt-5">
        ...
        <form class="g-3 form-control grey-border pb-5 p-3">
          <div class="col-lg-11 col-xl-9 col-xxl-8">
            <label for="name-input" class="form-label small"
              >Nome completo</label
            >
            <small
            ...
            <input
              ...
              id="name-input"
              v-model.trim="formInfo.costumerName"
              required
              minlength="3"
              maxlength="100"
            />
          ...
          <div class="col-lg-11 col-xl-9 col-xxl-8">
            <label for="phone-input" class="form-label small"
          ...
          <div class="col-lg-11 col-xl-9 col-xxl-8">
            <label for="address-input" class="form-label small"
              >Indirizzo</label
            >
            <input
              type="text"
              class="form-control grey-border form-control-lg border-readius-none"
              id="address-input"
              v-model.trim="formInfo.costumerAddress"
            />
          </div>
        </form>
      ...
      <div class="col-12 text-center">
        <div class="col-12 mt-3">
          <button
            ...
            id="payment"
            :disabled="
              formInfo.costumerName.trim() === '' ||
              formInfo.costumerAddress.trim() === '' ||
              formInfo.costumerPhone.trim() === '' ||
              formInfo.costumerMail.trim() === ''
            "
          >
            Ordine e paga
          </button>
