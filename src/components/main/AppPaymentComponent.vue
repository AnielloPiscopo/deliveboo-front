      ...
      <div class="col-12 col-lg-5 mt-5">
        ...
        <form class="g-3 form-control grey-border pb-5 p-3">
          <div class="col-lg-11 col-xl-9 col-xxl-8">
            ...
            <input type="text" class="form-control grey-border form-control-lg border-readius-none" id="name-input"
              v-model.trim="formInfo.costumerName">
          </div>
          <div class="col-lg-11 col-xl-9 col-xxl-8">
            <label for="mail-input" class="form-label small">Mail</label>
            <div class="input-group">
              <input type="mail" class="form-control grey-border form-control-lg border-readius-none" id="mail-input"
                v-model.trim="formInfo.costumerMail">
            </div>
          </div>
          <div class="col-lg-11 col-xl-9 col-xxl-8">
            <label for="phone-input" class="form-label small">Numero di telefono</label>
            <input type="tel" class="form-control grey-border form-control-lg border-readius-none" id="phone-input"
              v-model.trim="formInfo.costumerPhone">
          </div>
          <div class="col-lg-11 col-xl-9 col-xxl-8">
            <label for="address-input" class="form-label small">Indirizzo</label>
            <input type="text" class="form-control grey-border form-control-lg border-readius-none" id="address-input"
